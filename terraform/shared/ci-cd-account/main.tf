...
module "ci_cd_service_account" {
  ...
  account_id   = "todo-poc-ci-cd"
  display_name = "Todo POC CI/CD Service Account"
...
module "workload_identity" {
  ...
  service_account_id     = module.ci_cd_service_account.service_account_name
